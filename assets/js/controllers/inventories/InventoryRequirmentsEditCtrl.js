            ...
            },
            {
                ...
                columns: [
                   // { caption: $translate.instant('InventoryRequirmentItem.UnitCount'), dataField: "UnitCount", dataType: "number", format: { type: "fixedPoint", precision: 0 }, allowEditing: false, visibleIndex: 6 },
                    ...
                    { name: "Total", caption: $translate.instant('InventoryRequirmentItem.Total'), calculateCellValue: function (data) { return data.UnitCustom * data.UnitPrice*data.factor; }, visibleIndex: 8, format: { type: "fixedPoint", precision: 2 } },
                ]
            },
