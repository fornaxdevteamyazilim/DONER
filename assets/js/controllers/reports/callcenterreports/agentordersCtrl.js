...
function agentordersCtrl($scope, $filter, $window, $stateParams, $rootScope, $translate, userService, ngnotifyService, $element, NG_SETTING, $http, $q) {
    ...
    var store = new DevExpress.data.CustomStore({
       //key: "id",
        load: function (loadOptions) {
            ...
            return $http.get(NG_SETTING.apiServiceBaseUri + "/api/ccstats/agentorders", { params: params })
    ...
    $scope.dataGridOptions = {
       ...
       // columnChooser: { enabled: true, mode: "dragAndDrop" },
        columns: [
            ...
            { dataField: "UserName", caption: $translate.instant('callcenterreports.UserName'), dataType: "string" },
