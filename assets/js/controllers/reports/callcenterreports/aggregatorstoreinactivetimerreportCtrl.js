...
function aggregatorordersreportCtrl($scope, $filter, $window, $stateParams, $rootScope, $translate, userService, ngnotifyService, $element, NG_SETTING, $http, $q) {
    $rootScope.uService.EnterController("aggregatorordersreportCtrl");
    ...
    var store = new DevExpress.data.CustomStore({
       //key: "id",
        load: function (loadOptions) {
            ...
            return $http.get(NG_SETTING.apiServiceBaseUri + "/api/AggregatorStoreInactiveTimer/report", { params: params })
    ...
    $scope.dataGridOptions = {
       ...
       // columnChooser: { enabled: true, mode: "dragAndDrop" },
        columns: [
            ...
            { dataField: "Store", caption: $translate.instant('Aggregatorstoreinactivetimerreport.Store'), dataType: "string" },
            { dataField: "Aggregator", caption: $translate.instant('Aggregatorstoreinactivetimerreport.Aggregator'), dataType: "string" },
            { dataField: "OpDate", caption : $translate.instant('Aggregatorstoreinactivetimerreport.OpDate'),alignment: "right", dataType: "date", format: 'dd.MM.yyyy HH:mm'}, 
            { dataField: "InactiveTime", caption: $translate.instant('Aggregatorstoreinactivetimerreport.InactiveTime'), dataType: "string" },
        ...
        export: {
            enabled: true,
            fileName: "AggregatorStoreInactiveTimer",
        },
    ...
    $scope.$on('$destroy', function () {
        $element.remove();
        $rootScope.uService.ExitController("aggregatorordersreportCtrl");
    });
};
