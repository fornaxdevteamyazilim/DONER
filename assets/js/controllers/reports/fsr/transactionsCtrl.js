...
function transactionsCtrl($scope, $filter, $modal, $log, Restangular, SweetAlert, $timeout, toaster, $window, $rootScope, $compile, $location, $translate, ngnotifyService, $element, NG_SETTING, $http, $q) {
    ...
    $scope.dataGridOptions = {
        ...
        columns: [
            ...
            { caption: $translate.instant('transactions.HDS%'), dataField: "HDSSalesPercent", dataType: "number", format: { type: "percent", precision: 2 } },
            { caption: $translate.instant('transactions.DINSales'), dataField: "DINSales", dataType: "number", format: { type: "fixedPoint", precision: 2 } },
            { caption: $translate.instant('transactions.DIN%'), dataField: "DINSalesPercent", dataType: "number", format: { type: "percent", precision: 2 } },
            { caption: $translate.instant('transactions.COSales'), dataField: "COSales", dataType: "number", format: { type: "fixedPoint", precision: 2 } },
            { caption: $translate.instant('transactions.CO%'), dataField: "COSalesPercent", dataType: "number", format: { type: "percent", precision: 2 } },
            { caption: $translate.instant('transactions.HDSTrx'), dataField: "HDSTrx", dataType: "number", format: { type: "fixedPoint", precision: 2 } },
            { caption: $translate.instant('transactions.HDSTrx%'), dataField: "HDSTrxPercent", dataType: "number", format: { type: "percent", precision: 2 } },
            {  caption: $translate.instant('transactions.DINTrx') , dataField: "DINTrx", dataType: "number", format: { type: "fixedPoint", precision: 2 } },
            {  caption: $translate.instant('transactions.DINTrx%'), dataField: "DINTrxPercent", dataType: "number", format: { type: "percent", precision: 2 } },
            {  caption: $translate.instant('transactions.COTrx') , dataField: "COTrx", dataType: "number", format: { type: "fixedPoint", precision: 2 } },
            {  caption: $translate.instant('transactions.COTrx%') , dataField: "COTrxPercent", dataType: "number", format: { type: "percent", precision: 2 } },
