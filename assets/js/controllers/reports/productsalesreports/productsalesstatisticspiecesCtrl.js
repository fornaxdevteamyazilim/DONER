'use strict';
app.controller('productsalesstatisticspiecesCtrl', productsalesstatisticspiecesCtrl);
function productsalesstatisticspiecesCtrl($scope, $filter, $modal, $log, Restangular, localStorageService, SweetAlert, $timeout, toaster, $window, $rootScope, $compile, $location, $translate, ngnotifyService, $element, NG_SETTING) {
    ...
    $scope.pivotGridOptions = {
        ...
        "export": {
            enabled: true,
            fileName: "productsalesstatisticspieces"
        },
        scrolling: {
            mode: "virtual"
        },
        ...
        stateStoring: {
            enabled: true,
            type: "localStorage",
            storageKey: "dx-productsalesstatisticspieces-storing"
        },

        dataSource: {
            remoteOperations: true,
            fields: [   
                { caption: "Product", dataField: "name", area: "row", sortBySummaryField: "SalesAmount",   },
                ...
                { caption: "Amount", dataField: "Amount", summaryType: "sum", format: "fixedPoint", area: "filter", },
